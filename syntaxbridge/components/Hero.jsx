...
const Hero = () => {
  return (
    <section className="py-12 xl:py-24 sm:h-[65vh] xs:h-[100hv] xl:pt-28 bg-gradient-to-b from-[#eceff2] to-[#8197a8] dark:bg-gradient-to-b dark:from-[#0f0f12] dark:via-[#1d1f25] dark:to-[#393d41]">
      <div className="container xs:px-[1rem] mx-auto relative">
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-8 md:mb-10">
          ...
          <p className="text-[0.875rem] leading-[1.5rem] md:text-[1rem] md:leading-[1.75rem] lg:text-[1.25rem] lg:leading-8 md:max-w-3xl sm:max-w-lg mx-auto sm:mb-8 xs:mb-6 text-gray-700 dark:text-gray-400">
